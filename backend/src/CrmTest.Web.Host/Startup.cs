...
namespace CrmTest.Web.Host
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "CrmTest API", Version = "v1" });
            ...
            return services.AddAbp<CrmTestWebHostModule>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "CrmTest API V1");
            });

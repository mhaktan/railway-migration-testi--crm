...
namespace CrmTest
{
    public class CrmTestCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = string.IsNullOrEmpty(envConnStr)
                ? CrmTestConsts.ConnectionStringName
                : envConnStr;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CrmTestCoreModule).GetAssembly());
        }
    }
}

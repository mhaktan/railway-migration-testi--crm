...
const RESOURCE_CONFIG: Record<string, ResourceConfig> = {
  'Customer': { path: 'api/services/app/Customer', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'Note': { path: 'api/services/app/Note', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
